    ...
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          ...
          <div className="bg-gradient-to-t inset-x-0 z-20 bottom-0 bg-white dark:bg-background h-full absolute [mask-image:radial-gradient(900px_at_center,transparent_30%,white)]" />
        </motion.div>
      )}
    </AnimatePresence>
  );
