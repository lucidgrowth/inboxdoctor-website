...
metaTitle: Privacy Policy | InboxDoctor Email Security & Data Protection Guidelines
metaDescription: Learn how InboxDoctor safeguards your email data with our comprehensive privacy policy. Understand your rights, how we use your information, and our commitment to transparent data practices.
---

## INTRODUCTION

This Privacy Notice for InboxDoctor LLC ("**we**," "**us**," or "**our**"), describes how and why we might access, collect, store, use, and/or share ("**process**") your personal information when you use our services ("**Services**"), including when you:

- Visit our website at [https://www.inboxdoctor.ai](https://www.inboxdoctor.ai), or any website of ours that links to this Privacy Notice

- Use InboxDoctor. InboxDoctor is an advanced email deliverability and warm-up platform designed to help users improve inbox placement, monitor sender reputation, and optimize email performance. It provides tools for mailbox management, domain reputation tracking, spam rate analysis, and real-time deliverability insights. With features like automated email warm-up, Google Postmaster integration, seed list testing, and email content optimization, InboxDoctor ensures that emails reach their intended recipients while minimizing spam folder placement. Ideal for businesses, marketers, and email senders, InboxDoctor enhances email-sending success by providing actionable recommendations, live monitoring, and deliverability best practices.

- Engage with us in other related ways, including any sales, marketing, or events

**Questions or concerns?** Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at support@inboxdoctor.ai.
...
**How do you exercise your rights?** The easiest way to exercise your rights is by submitting a [data subject access request](https://app.termly.io/notify/f35e61c6-7d37-4501-bd04-4fa12c80ffab), or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
...
**Payment Data.** We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by Stripe, Inc.. You may find their privacy notice link(s) here: [https://stripe.com/in/privacy](https://stripe.com/in/privacy).
...
If you interact with us on a social media platform using your social media account (e.g., Facebook or X), we receive personal information about you from such platforms such as your name, email address, and gender. You may have the right to withdraw your consent to processing your personal information. Learn more about [withdrawing your consent](https://app.termly.io/policy-viewer/policy.html?policyUUID=7d8f2eee-af0e-4d0f-8fe2-2157515dc73b#withdrawconsent "https://app.termly.io/policy-viewer/policy.html?policyuuid=7d8f2eee-af0e-4d0f-8fe2-2157515dc73b#withdrawconsent"). Any personal information that we collect from your social media account depends on your social media account's privacy settings. Please note that their own use of your information is not governed by this Privacy Notice.

### **Google User Data Privacy Notice**

Certain features of the Services, including our Collaborative Inbox, and Workflow Automation features, need to process information from users’ Google Workspace applications, such as Gmail and Calendar, which we access through Google’s Workspace APIs (“**Google User Data**”). Google User Data is part of the Customer Data that we handle on behalf of Customers subject to our Customer agreements. However, our handling of Google User Data is also restricted by Google’s [API Terms of Service](https://developers.google.com/terms "https://developers.google.com/terms") and [Google User Data Policy](https://developers.google.com/terms/api-services-user-data-policy "https://developers.google.com/terms/api-services-user-data-policy"), including its [Limited Use requirements](https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes "https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes") (collectively, “**Google Requirements**”). We are providing this Google Workspace API Privacy Notice as required by the Google Requirements to explain how we access, use, store, and share Google User Data. Please note that the other sections of this Notice do not apply to Google User Data. When you choose to use these features, we access your Google User Data with your authorization and we use, store and share Google User Data to enable and improve these features in accordance with the Google Requirements. We explicitly affirm that Google Workspace APIs are not used to develop, improve, or train generalized or non-personalized AI and/or ML models. Our commitment to protecting user privacy extends to all aspects of our AI/ML development processes, and we adhere to strict guidelines regarding the use of Google Workspace data. Any data accessed through Google Workspace APIs is used solely for personalized, user-specific enhancements and not for creating generalized models that could be applied beyond the scope of the individual user.

We explicitly affirm that Google Workspace APIs are not used to develop, improve, or train generalized or non-personalized AI and/or ML models. Our commitment to protecting user privacy extends to all aspects of our AI/ML development processes, and we adhere to strict guidelines regarding the use of Google Workspace data. Any data accessed through Google Workspace APIs is used solely for personalized, user-specific enhancements and not for creating generalized models that could be applied beyond the scope of the individual user. We use technical, organizational, and physical measures designed to protect the confidentiality, integrity and availability of Google User Data and we retain and delete Google User Data in accordance with Customer instructions. For details on these practices, see the InboxDoctor [Terms and Condition](https://www.inboxdoctor.ai/legal/terms-and-conditions "https://www.inboxdoctor.ai/legal/terms-and-conditions").
...
If you have questions or comments about your privacy rights, you may email us at support@inboxdoctor.ai.
...
To exercise these rights, you can contact us by submitting a [data subject access request](https://app.termly.io/notify/f35e61c6-7d37-4501-bd04-4fa12c80ffab), by emailing us at support@inboxdoctor.ai, or by referring to the contact details at the bottom of this document.
...
Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at support@inboxdoctor.ai. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.
...
If you have questions or comments about this notice, please email us at [support@inboxdoctor.ai](mailto:support@inboxdoctor.ai) or by post to:

<span>
  InboxDoctor LLC <br />
  300 Delaware Ave Ste 210 #207 <br />
