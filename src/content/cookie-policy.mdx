...
metaTitle: Cookie Policy | InboxDoctor
metaDescription: Understand InboxDoctor's cookie policy. Discover how we use cookies to enhance your experience while prioritizing your privacy.
---

## Introduction

This Cookie Policy explains how InboxDoctor LLC ("**Company**," "**we**," "**us**," and "**our**") uses cookies and similar technologies to recognize you when you visit our website at [https://www.inboxdoctor.ai](https://www.inboxdoctor.ai) ("**Website**"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
...
Cookies set by the website owner (in this case, InboxDoctor LLC) are called "first-party cookies." Cookies set by parties other than the website owner are called "third-party cookies." Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.
...
If you have any questions about our use of cookies or other technologies, please email us at [support@inboxdoctor.ai](mailto:support@inboxdoctor.ai) or by post to:
